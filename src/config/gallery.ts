...
const EXCLUDE: string[] = [
  ...
  "YS_00467", // Ending (2026-09-14 교체. 이전 YS_03366 은 갤러리로 복귀하지 않음 — 다크 스튜디오 3장으로 충분)
  "YS_03366",
...
export const FEATURED = {
  ...
  /** 엔딩 시 배경. 2026-09-14: 소파에서 둘이 웃는 컷(밝은 사진 → endingTone light). 대안: YS_04128(검은 문 앞에서 웃으며 걸어 나오는 컷). */
  ending: "YS_00467",
  /** 가로 사진을 3:4 로 자를 때 보여줄 위치 (CSS object-position) */
  endingPosition: "center",
  /** 엔딩 글 톤. dark: 흰 글씨(어두운 하단) / light: 차콜 글씨 + 흰색 스밈(밝은 하단) */
  endingTone: "light" as "dark" | "light",
} as const;
