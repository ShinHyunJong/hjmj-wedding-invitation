 ...
 * - **촬영 장소별로 묶어 배치**한다 (2026-09-14 사용자 요청). MS_/YS_ 는 작가 구분이라 섞여도 되며 파일 번호순은 장소 순서와 다르다.
...
const ORDER: string[] = [
  // ── 실내 ──
  // ① 화이트 스튜디오 (창가 빛 · 베일)
  "YS_01984", // 베일 클로즈업 (2026-09-14 교체)
  "YS_00365", // 소파에 앉은 둘
  // ② 화이트 스튜디오, 강아지와
  "MS_01359", // 셋이 함께
  "YS_03902", // 의자에 앉은 신랑과 강아지 (2026-09-14 추가)
  "YS_02664", // 부케 클로즈업
  "YS_02743", // 강아지와 셋, 무릎
  "YS_03038", // 손등 키스
  // ③ 다크 스튜디오
  "YS_03061", // 튤립, 둘
  "YS_03217", // 신부
  "YS_03501", // 베일 아래 둘 (2026-09-14 추가)
  "MS_01708", // 베일 들어 올리는 둘
  "YS_03741", // 핑크 부케
  // ④ 소파 · 크림 커튼 (강아지 컷은 2장만 — 2026-09-14 "보꼬 사진 너무 많다" 피드백으로 05012 · 05113 · 05219 제외)
  "YS_00467", // 소파에 앉은 둘
  ...
  "MS_00500", // 잔디, 강아지와
  "YS_01595", // 클래식카 부감
  "MS_00665", // 클래식카 안 둘 (가로)
  "MS_02165", // 클래식카 옆 신랑
  // ⑩ 마무리 — 정원 키스 · 샴페인 (2026-09-14 사용자 요청: 맨 마지막)
  "MS_02387", // 정원 키스 (가로)
  "YS_05638", // 정원 샴페인
];
...
export const FEATURED = {
  ...
  /** 엔딩 시 배경. 2026-09-14 최종: 정원에서 샴페인 터뜨리는 컷(YS_05644) + 은은한 검은 오버레이 + 흰 글씨(dark). */
  ending: "YS_05644",
  /** 가로 사진을 3:4 로 자를 때 보여줄 위치 (CSS object-position) */
  endingPosition: "center",
  /** 엔딩 글 톤. dark: 흰 글씨(어두운 하단) / light: 차콜 글씨 + 흰색 스밈(밝은 하단) */
  endingTone: "dark" as "dark" | "light",
} as const;

const byId = new Map(manifest.map((p) => [p.id, withFocal(p as Omit<GalleryPhoto, "focal">)]));

/** 갤러리에 보여줄 사진 (GALLERY_COUNT 장, ORDER 순서) */
